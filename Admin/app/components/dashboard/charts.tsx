...
import { revenueData, categoryData, peakHoursData, weeklyOrdersData } from "@/app/lib/mock-data";
  ...
  return (
    <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-6">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <BarChart data={peakHoursData} margin={{ top: 0, right: 0, left: -10, bottom: 0 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={GRID} vertical={false} />
...
export function WeeklyOrdersChart() {
  return (
    <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-6">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={weeklyOrdersData} margin={{ top: 0, right: 0, left: -10, bottom: 0 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={GRID} vertical={false} />
